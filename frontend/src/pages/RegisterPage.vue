<template>
  ...
  >
    <Card class="w-full sm:w-6 lg:w-4 p-4">
      <template #title>
        <h2 class="text-center text-xl font-semibold">Register Mini LinkedIn</h2>
      </template>

      <template #content>
        <form @submit.prevent="handleRegister" class="flex flex-column gap-3 mt-3">
          <div class="flex flex-column gap-1">
            ...
            <InputText
              ...
              placeholder="Joe Doe"
            />
            <small v-if="submitted && !passwordValid" class="p-error"> Name is required. </small>
          </div>
          ...
          <div class="flex flex-column gap-1">
            ...
            />
            <small v-if="submitted && !emailValid" class="p-error"> Invalid email. </small>
          </div>
          ...
          <div class="flex flex-column gap-1">
            ...
            <Password
              ...
              toggleMask
              :feedback="false"
              :inputClass="submitted && !passwordValid ? 'p-invalid w-full' : 'w-full'"
            />
          ...
          <div class="flex flex-column gap-1">
            ...
            />
            <small v-if="submitted && !roleValid" class="p-error"> A role is required. </small>
          </div>
...
const handleRegister = () => {
  ...
  if (!emailValid.value || !passwordValid.value || !nameValid.value || !roleValid.value) return;
