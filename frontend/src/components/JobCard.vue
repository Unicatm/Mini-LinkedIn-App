<template>
  <Card class="shadow-1 border-round-xl mb-3 hover:shadow-3 transition-duration-200">
    <template #title>
...
const goToRecruiterProfile = () => {
  if (props.job.recruiterId) {
    router.push({
